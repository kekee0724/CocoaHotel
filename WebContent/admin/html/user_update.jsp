...
<%
	User pwd = (User) request.getAttribute("pwd");
%>
<body>
	<!-- start content-outer -->
			...
			<table border="0" width="100%" cellpadding="0" cellspacing="0"
				...
				<tr>
					<th rowspan="3" class="sized"><img
						src="../images/side_shadowleft.jpg" width="20" height="230" alt="" /></th>
					<th class="topleft"></th>
					<td id="tbl-border-top">&nbsp;</td>
					<th class="topright"></th>
					<th rowspan="3" class="sized"><img
						src="../images/side_shadowright.jpg" width="20" height="230"
						alt="" /></th>
				</tr>
				<tr>
								...
								<tr>
									<td height="50" valign="top"><div class="error-left"></div>
										<div class="error-inner">
											<h3 class="add">您当前的位置：用户管理 > 修改用户</h3>
										</div></td>
								</tr>
								<tr valign="top">
									<td>
										...
										<form
											...
											method="post">
											<input value="<%=pwd.getPk()%>" name="userpk" type="hidden" />
											<table border="0" cellpadding="0" cellspacing="0"
												...
												<tr>
													...
													<td><input type="text" name="xpassword"
														class="inp-form-error large_input" /></td>
													<td><div class="error-left"></div>
														<div class="error-inner">必填项*</div></td>
												</tr>
